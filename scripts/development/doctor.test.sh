...
assert_failure 'Node 20 EOL lane' node_version_supported '20.19.0'
...
assert_failure 'Node 23 odd lane' node_version_supported '23.11.1'
assert_success 'Node 24 supported lane' node_version_supported '24.0.0'
assert_failure 'Node 25 odd lane' node_version_supported '25.0.0'
assert_failure 'Node 26 unvalidated future lane' node_version_supported '26.0.0'

printf 'Doctor rule tests passed: 17 checks.\n'
