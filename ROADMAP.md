...
C001, the deterministic relative Markdown link check, C002, the synthetic local API cookbook, C003, validated synthetic OpenAPI examples, and C004, the focused synthetic legacy mobile-auth fixture helper, are complete in the repository. Their issue drafts remain non-publishable until the governance and launch gates below are complete.
