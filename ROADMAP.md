...
C001, the deterministic relative Markdown link check, and C003, validated synthetic OpenAPI examples, are complete in the repository. Their issue drafts remain non-publishable until the governance and launch gates below are complete.
